...
var file_recordsales_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xfb, 0x01, 0x0a, 0x0b, 0x53,
	...
	0x67, 0x69, 0x63, 0x2f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x61, 0x6c, 0x65, 0x73, 0x2f,
...
var file_recordsales_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_recordsales_proto_goTypes = []interface{}{
	...
	nil,                         // 10: recordsales.Config.PriceHistoryEntry
}
var file_recordsales_proto_depIdxs = []int32{
	...
	10, // 3: recordsales.Config.price_history:type_name -> recordsales.Config.PriceHistoryEntry
	...
	1,  // 6: recordsales.Config.PriceHistoryEntry.value:type_name -> recordsales.Prices
	4,  // 7: recordsales.SaleService.GetStale:input_type -> recordsales.GetStaleRequest
	6,  // 8: recordsales.SaleService.GetSaleState:input_type -> recordsales.GetStateRequest
	8,  // 9: recordsales.SaleService.UpdatePrice:input_type -> recordsales.UpdatePriceRequest
	5,  // 10: recordsales.SaleService.GetStale:output_type -> recordsales.GetStaleResponse
	7,  // 11: recordsales.SaleService.GetSaleState:output_type -> recordsales.GetStateResponse
	9,  // 12: recordsales.SaleService.UpdatePrice:output_type -> recordsales.UpdatePriceResponse
